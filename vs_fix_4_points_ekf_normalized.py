...
import pickle
import cv2
from all_utils.vs_utils import dq_to_speeds_in_cam, skew, skew_to_vector, one_point_depth_jacobian
...
if __name__ == '__main__':
    ...
    for i in range(num_sample):
        ...
        obstacle_corners_in_cam, obstacle_corners_in_world = get_apriltag_corners_cam_and_world_homo_coord(
